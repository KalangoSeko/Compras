          ...
          <div class="col-md-12">
            <div class="container">
              <div class="card card-container">
                ...
                <form class="form-signin" method="POST" action="leindex.php">
                  <span id="reauth-email" class="reauth-email"></span>
                  <input type="string" name="login" id="login" class="form-control" placeholder="Login" required="" autofocus="">
                  <br>
...
echo $msg;
                ...
                <a href="esqueceusuasenha.html" class="forgot-password">
                 Esqueceu sua senha?
            </a>
                <br>
